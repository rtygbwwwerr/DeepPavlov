...
@register('keras_classification_model_fast')
class KerasClassificationModelFast(KerasModel):
    """
    ...
    def train_on_batch(self, texts: List[List[np.ndarray]], labels: list) -> [float, List[float]]:
        ...
        metrics_values = self.model.train_on_batch(features, y)
        endtime = datetime.datetime.now()
        print("train_on_batch time:{}".format((endtime - starttime).microseconds))
